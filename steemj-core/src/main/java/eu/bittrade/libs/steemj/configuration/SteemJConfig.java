...
public class SteemJConfig {
     ...
     * The SteemJ account.
     */
    private static final AccountName STEEMJ_ACCOUNT = new AccountName("yuriks2000");
    /**
     * The SteemJ version.
     */
     ...
     *
     * @param endpointURI             The URI of the node you want to connect to.
     * @param sslVerificationDisabled Define if SteemJ should verify the SSL certificate of the
     ...
     *
     * @param steemJWeight The beneficiary weight for SteemJ.
     */
     ...
     *
     * @param vestsSymbol The {@link AssetSymbolType} for VESTS to set.
     */
    ...
    public static String getSteemJVersion() {
        return APP_VERSION == null ? STEEMJ_VERSION : APP_VERSION;
    }
    ...
    public static String getSteemJAppName() {
        return APP_NAME == null ? STEEMJ_NAME : APP_NAME;
    }
