...
//        }
     ...
     *                                          requirements described above.
     */
    public CommentOperation createPost(String title, String content, String[] tags, short rewardsPercent)
            throws SteemCommunicationException, SteemResponseException, SteemInvalidTransactionException {
        if (SteemJConfig.getInstance().getDefaultAccount().isEmpty()) {
            throw new InvalidParameterException(NO_DEFAULT_ACCOUNT_ERROR_MESSAGE);
        }

        return createPost(SteemJConfig.getInstance().getDefaultAccount(), title, content, tags, rewardsPercent);
    }

    /**
     * This method is equivalent to the
     * {@link #createPost(String, String, String[], short)} method, but lets you define
    ...
    public CommentOperation createPost(AccountName authorThatPublishsThePost, String title, String content,
        ...
        short percentSteemDollars = rewardsPercent; // (short) 10000;
     ...
     *                                          requirements described above.
     */
    public CommentOperation createPostSynchronous(String title, String content, String[] tags, short rewardsPercent)
            throws SteemCommunicationException, SteemResponseException, SteemInvalidTransactionException {
        if (SteemJConfig.getInstance().getDefaultAccount().isEmpty()) {
            throw new InvalidParameterException(NO_DEFAULT_ACCOUNT_ERROR_MESSAGE);
        }
    ...
    public CommentOperation createPostSynchronous(AccountName authorThatPublishsThePost, String title, String content,
        ...
        BroadcastTransactionSynchronousReturn result = this.broadcastTransactionSynchronous(signedTransaction);
